//Shawn Jaffe Final Project: hashlineardriver.cpp
#include <iostream>
#include <fstream>
#include <thread>
#include <chrono>
...
*/
  ...
  */
        ...
        int totalCollisions = Linear.getNumOfCollision();
     ...
     */
        ...
        for (int j = currentLowerBound; j <= currentUpperBound; j++){
            ...
            Linear.searchItem(testDataA[random]);
        }
        ...
        //get the number of total collisions
        int totalSearchCollisions = Linear.getNumOfSearchCollision();
    ...
    //open outFile
    outFile.open("DataSetALinear.csv");

    //print insert times to the output file
    outFile << "Insert times: " << endl;

    //insert the insert times for data set A into DataSetALinear.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the search times for data set A into DataSetALinear.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the insert collisions for data set A into DataSetALinear.csv
    for (int i = 0; i < 100; i++){
        outFile << insertCollisionsA[i] << endl;
    }

    //print search collsions to the output file
    outFile << "Search collisions: " << endl;

    //insert the search collisions for data set A into DataSetALinear.csv
    for (int i = 0; i < 100; i++){
        outFile << searchCollisionsA[i] << endl; 
    }

    //print the total number of insert and search collisions at the end of the output file
    outFile << "Insert Collisions: " << Linear.getNumOfCollision() << endl;
    outFile << "Search Collisions: " << Linear.getNumOfSearchCollision() << endl; 
...
*/
    ...
    {
        //convert the ID2 from a string to an integer
        int IDNum = stoi(ID2);
  ...
  */
        ...
        for (int j = currentLowerBound; j <= currentUpperBound; j++){
            //insert the ID number into the Hash Table Linear 
            Linear2.insertItem(testDataB[j]);
        }
        ...
        //get the number of total collisions
        int totalCollisions = Linear2.getNumOfCollision();
     ...
     */
        ...
        for (int j = currentLowerBound; j <= currentUpperBound; j++){
            int random = (rand() % 100) + currentLowerBound;
            Linear2.searchItem(testDataB[random]);
        }
        ...
        //get the number of total collisions
        int totalSearchCollisions = Linear2.getNumOfSearchCollision();
    ...
    //open outFile
    outFile2.open("DataSetBLinear.csv");

    //print insert times to the output file
    outFile2 << "Insert times: " << endl;

    //insert the insert times for data set B into DataSetBLinear.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the search times for data set B into DataSetBLinear.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the insert collisions for data set B into DataSetBLinear.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the search collisions for data set B into DataSetBLinear.csv
    for (int i = 0; i < 100; i++){
        outFile2 << searchCollisionsB[i] << endl; 
    }

    //print the total number of insert and search collisions at the end of the output file
    outFile2 << "Insert Collisions: " << Linear2.getNumOfCollision() << endl;
    outFile2 << "Search Collisions: " << Linear2.getNumOfSearchCollision() << endl; 
