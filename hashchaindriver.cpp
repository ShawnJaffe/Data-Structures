//Shawn Jaffe Final Project: hashchaindriver.cpp
#include <iostream>
#include <fstream>
#include <thread>
#include <chrono>
...
*/
    ...
    //declare object of Hash Table Chain class
    HashTable Chain(40009);
    ...
    //create variables to store the collisions before its updated, and collisions per 100
  ...
  */
        ...
        for (int j = currentLowerBound; j <= currentUpperBound; j++){
            //insert the ID number into the Hash Table Chain 
            Chain.insertItem(testDataA[j]);
        }
        ...
        int totalCollisions = Chain.getNumOfCollision();
     ...
     */
        ...
        for (int j = currentLowerBound; j <= currentUpperBound; j++){
            ...
            Chain.searchItem(testDataA[random]);
        }
        ...
        //get the number of total collisions
        int totalSearchCollisions = Chain.getNumOfSearchCollision();
    ...
    //open outFile
    outFile.open("DataSetAChain.csv");

    //print insert times to the output file
    outFile << "Insert times: " << endl;

    //insert the insert times for data set A into DataSetAChain.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the search times for data set A into DataSetAChain.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the insert collisions for data set A into DataSetAChain.csv
    for (int i = 0; i < 100; i++){
        outFile << insertCollisionsA[i] << endl;
    }

    //print search collisons to the output file
    outFile << "Search collisions: " << endl;

    //insert the search collisions for data set A into DataSetAChain.csv
    for (int i = 0; i < 100; i++){
        outFile << searchCollisionsA[i] << endl;
    }

    //print the total number of insert and search collisions at the end of the output file
    outFile << "Insert Collisions: " << Chain.getNumOfCollision() << endl;
    outFile << "Search Collisions: " << Chain.getNumOfSearchCollision() << endl; 
...
*/
  ...
  */
        ...
        //get the number of total collisions
        int totalCollisions = Chain2.getNumOfCollision();
    ...
    for (int i = 0; i < 100; i++){
        ...
        for (int j = currentLowerBound; j <= currentUpperBound; j++){
            int random = (rand() % 100) + currentLowerBound;
            Chain2.searchItem(testDataB[random]);
        }
        ...
        //get the number of total collisions
        int totalSearchCollisions = Chain2.getNumOfSearchCollision();
    ...
    //open outFile
    outFile2.open("DataSetBChain.csv");

    //print insert times to the output file
    outFile2 << "Insert times: " << endl;

    //insert the insert times for data set B into DataSetBChain.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the search times for data set B into DataSetBChain.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the insert collisions for data set B into DataSetBChain.csv
    for (int i = 0; i < 100; i++){
    ...
    //insert the search collisions for data set B into DataSetBChain.csv
    for (int i = 0; i < 100; i++){
        outFile2 << searchCollisionsB[i] << endl;
    }

    //print the total number of insert and search collisions at the end of the output file
    outFile2 << "Insert Collisions: " << Chain2.getNumOfCollision() << endl;
    outFile2 << "Search Collisions: " << Chain2.getNumOfSearchCollision() << endl; 
